...
namespace SharpUpdate
{
    ...
    internal class SharpUpdateXml
    {
        ...
        /// </summary>
        internal SharpUpdateXml(Version version, Uri uri, string fileName, string description, string launchArgs)
        {
        ...
        internal static SharpUpdateXml Parse(Uri location, string appID)
        {
            ...
            try
            {
				...
				return new SharpUpdateXml(version, new Uri(url), fileName,description, launchArgs);
            }
			catch { return null; }
        }
    }
